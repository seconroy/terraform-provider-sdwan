...
type DNSSecurityDNS struct {
	...
	TargetVpns               []DNSSecurityDNSTargetVpns `tfsdk:"target_vpns"`
}

type DNSSecurityDNSTargetVpns struct {
...
func (data DNSSecurityDNS) getModel() string {
	return "dns_security_dns"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data DNSSecurityDNS) getPath() string {
...
func (data DNSSecurityDNS) toBody(ctx context.Context) string {
	body := ""
...
func (data *DNSSecurityDNS) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "targetVpns"); value.Exists() {
		data.TargetVpns = make([]DNSSecurityDNSTargetVpns, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := DNSSecurityDNSTargetVpns{}
...
func (data *DNSSecurityDNS) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *DNSSecurityDNS) isNull(ctx context.Context, res gjson.Result) bool {
