...
var (
	_ datasource.DataSource              = &PimFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &PimFeatureTemplateDataSource{}
)

func NewPimFeatureTemplateDataSource() datasource.DataSource {
	return &PimFeatureTemplateDataSource{}
}

type PimFeatureTemplateDataSource struct {
	client *sdwan.Client
}

func (d *PimFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_pim_feature_template"
}

func (d *PimFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the pim feature template.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"shutdown": schema.BoolAttribute{
				MarkdownDescription: "Enable or disable PIM",
				Computed:            true,
			},
			...
			"replicator": schema.StringAttribute{
				MarkdownDescription: "Set how replicator is selected",
				Computed:            true,
			},
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"hello_interval": schema.Int64Attribute{
							MarkdownDescription: "Set interval between PIM hello packets",
							Computed:            true,
						},
...
func (d *PimFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *PimFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *PimFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config Pim
