...
var (
	_ datasource.DataSource              = &NtpFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &NtpFeatureTemplateDataSource{}
)

func NewNtpFeatureTemplateDataSource() datasource.DataSource {
	return &NtpFeatureTemplateDataSource{}
}

type NtpFeatureTemplateDataSource struct {
	client *sdwan.Client
}

func (d *NtpFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ntp_feature_template"
}

func (d *NtpFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the ntp feature template.",
...
func (d *NtpFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *NtpFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *NtpFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config Ntp
