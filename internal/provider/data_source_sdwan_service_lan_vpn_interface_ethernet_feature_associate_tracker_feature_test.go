...
func TestAccDataSourceSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeaturePrerequisitesConfig + testAccDataSourceSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeatureConfig(),
...
const testAccDataSourceSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeaturePrerequisitesConfig = `
...
func testAccDataSourceSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeatureConfig() string {
	config := ""
	...
	config += `
		data "sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature" "test" {
			feature_profile_id = sdwan_service_feature_profile.test.id
			service_lan_vpn_feature_id = sdwan_service_lan_vpn_feature.test.id
			service_lan_vpn_interface_ethernet_feature_id = sdwan_service_lan_vpn_interface_ethernet_feature.test.id
			id = sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature.test.id
		}
	`
	return config
}
