...
func TestAccSdwanTopologyMeshProfileParcel(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTopologyMeshPrerequisitesProfileParcelConfig + testAccSdwanTopologyMeshProfileParcelConfig_minimum(),
			},
			{
...
const testAccSdwanTopologyMeshPrerequisitesProfileParcelConfig = `
...
func testAccSdwanTopologyMeshProfileParcelConfig_minimum() string {
...
func testAccSdwanTopologyMeshProfileParcelConfig_all() string {
	config := `resource "sdwan_topology_mesh_feature" "test" {` + "\n"
