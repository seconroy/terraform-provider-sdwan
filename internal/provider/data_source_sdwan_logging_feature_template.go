...
var (
	_ datasource.DataSource              = &LoggingFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingFeatureTemplateDataSource{}
)

func NewLoggingFeatureTemplateDataSource() datasource.DataSource {
	return &LoggingFeatureTemplateDataSource{}
}

type LoggingFeatureTemplateDataSource struct {
	client *sdwan.Client
}

func (d *LoggingFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_logging_feature_template"
}

func (d *LoggingFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the logging feature template.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"priority": schema.StringAttribute{
				MarkdownDescription: "Set logging level for messages logged to disk",
				Computed:            true,
			},
...
func (d *LoggingFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *LoggingFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *LoggingFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config Logging
