...
var (
	_ datasource.DataSource              = &DNSSecurityDNSProfileParcelDataSource{}
	_ datasource.DataSourceWithConfigure = &DNSSecurityDNSProfileParcelDataSource{}
)

func NewDNSSecurityDNSProfileParcelDataSource() datasource.DataSource {
	return &DNSSecurityDNSProfileParcelDataSource{}
}

type DNSSecurityDNSProfileParcelDataSource struct {
	client *sdwan.Client
}

func (d *DNSSecurityDNSProfileParcelDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dns_security_dns_feature"
}

func (d *DNSSecurityDNSProfileParcelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the DNS Security DNS Feature.",
...
func (d *DNSSecurityDNSProfileParcelDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *DNSSecurityDNSProfileParcelDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DNSSecurityDNS
