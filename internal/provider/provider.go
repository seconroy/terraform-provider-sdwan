...
func (p *SdwanProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewPolicyObjectColorProfileParcelResource,
		NewPolicyObjectDataIPv6PrefixProfileParcelResource,
		NewPolicyObjectDataPrefixProfileParcelResource,
		NewPolicyObjectExpandedCommunityProfileParcelResource,
		NewPolicyObjectExtendedCommunityProfileParcelResource,
		NewPolicyObjectIPv6PrefixProfileParcelResource,
		NewPolicyObjectMirrorProfileParcelResource,
		NewPolicyObjectPolicerProfileParcelResource,
		NewPolicyObjectPrefixProfileParcelResource,
		NewPolicyObjectTLOCProfileParcelResource,
...
func (p *SdwanProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewPolicyObjectColorProfileParcelDataSource,
		NewPolicyObjectDataIPv6PrefixProfileParcelDataSource,
		NewPolicyObjectDataPrefixProfileParcelDataSource,
		NewPolicyObjectExpandedCommunityProfileParcelDataSource,
		NewPolicyObjectExtendedCommunityProfileParcelDataSource,
		NewPolicyObjectIPv6PrefixProfileParcelDataSource,
		NewPolicyObjectMirrorProfileParcelDataSource,
		NewPolicyObjectPolicerProfileParcelDataSource,
		NewPolicyObjectPrefixProfileParcelDataSource,
		NewPolicyObjectTLOCProfileParcelDataSource,
