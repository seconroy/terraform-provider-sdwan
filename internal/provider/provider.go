...
func (p *SdwanProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewTopologyHubAndSpokeProfileParcelResource,
		...
		NewServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeatureResource,
		NewServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeatureResource,
		...
		NewTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeatureResource,
...
func (p *SdwanProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewTopologyHubAndSpokeProfileParcelDataSource,
		...
		NewServiceLANVPNInterfaceEthernetFeatureAssociateTrackerFeatureDataSource,
		NewServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeatureDataSource,
		...
		NewTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeatureDataSource,
